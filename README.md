...
<p align="center">
  ...
  A native macOS workspace for coding agents, worktrees, reviews, and PRs before your desktop turns into confetti.
</p>
...
the surrounding work in one native workspace.
...
This repo is the clean v0 scaffold. It intentionally contains only the native shell and layout
foundation before the task, terminal, and review layers arrive.
...
| Future terminal | native PTY from Rust + browser terminal view |
...
1. Define the task/repo/tab/pane model.
