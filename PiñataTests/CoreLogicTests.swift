...
final class CoreLogicTests: XCTestCase {
    ...
    func testAgentTitleActivityRecognizesSpinnerFrame() {
        ...
        XCTAssertTrue(detector.update(title: "π ⠸ Investigate branch deletion issue"))
        XCTAssertTrue(detector.update(title: "Claude 🌘 Review changes"))
        XCTAssertTrue(detector.update(title: "🌒 Review changes"))
    }
    ...
    func testAgentTitleActivityStopsWithoutSpinnerFrame() {
        ...
        XCTAssertFalse(detector.update(title: "π · Investigate branch deletion issue"))
        XCTAssertFalse(detector.update(title: "Claude · Review changes"))
    }
