...
4. Read [SSH connections](ssh-connections.md) before changing remote repositories or terminal targets.
5. Treat everything under [`incoming/`](incoming/) as a proposal, not current behavior.
